...
<img src="post.png" width="1000"></a>

<a href="https://github.com/ultralytics/yolov5/actions"><img src="https://github.com/ultralytics/yolov5/workflows/CI%20CPU%20testing/badge.svg" alt="CI CPU testing"></a>

This project is based on version 5.0 of yolov5. It mainly carries out target detection for face mask carrying and occlusion. The project data is not uploaded, so the weight can be used directly. The pre training weight is [yolov5s] [assets].
...
Namespace(agnostic_nms=False, augment=False, classes=None, conf_thres=0.25, device='', exist_ok=False, img_size=640, iou_thres=0.45, name='2000_1CBAM_3classes', project='runs/detect', save_conf=False, save_txt=False, source='data/images/', update=False, view_img=False, weights=['yolov5s.pt'])
...
Results saved to runs/detect/1000_2CBAM_2classes
Done. (0.103s)
```

...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'E:\repository\taishen-s222\Deeplearning\yolov5-5.0\runs\train\2000_None_3classes\weights\best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=r'E:\repository\taishen-s222\Deeplearning\yolov5-5.0\data\mp4_test/test.mp4', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--name', default='2000_1CBAM_3classes', help='save results to project/name')
